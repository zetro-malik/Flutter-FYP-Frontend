...
import 'package:flutter_project_screens/Screens/ozaifa/post_quiz_image_screen.dart';
...
class ORoomData extends StatefulWidget {
  const ORoomData({super.key});

  @override
  State<ORoomData> createState() => _ORoomDataState();
}

class _ORoomDataState extends State<ORoomData> {
  @override
